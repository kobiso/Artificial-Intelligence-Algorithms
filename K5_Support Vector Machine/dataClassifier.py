...
def readCommand( argv ):
  ...
  parser.add_option('-c', '--classifier', help=default('The type of classifier'), choices=['mostFrequent', 'nb', 'naiveBayes', 'GDA', 'logisticRegression', 'lr', 'gpClassification', 'gpc', 'svm', 'SVM'], default='mostFrequent')
  ...
  elif(options.classifier == "svm" or options.classifier == "SVM"):
    classifier = svm.SupportVectorMachine(legalLabels, "SVM", options.data)
...
def runClassifier(args, options):
  ...
  if options.classifier == "GDA" or options.classifier == "LR" or options.classifier == "SVM":
    import os.path
